...
var Dialog = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Dialog, [{
    ...
    value: function renderMaximizeIcon() {
      var iconClassName = (0, _classnames.default)('p-dialog-header-maximize-icon pi', {
    ...
    value: function renderContent() {
      ...
      var contentClassName = (0, _classnames.default)('p-dialog-content', this.props.contentClassName);
      return /*#__PURE__*/_react.default.createElement("div", {
        ref: function ref(el) {
