...
var AutoComplete = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AutoComplete, [{
    ...
    value: function renderChips() {
      ...
      if (this.props.value && this.props.value.length) {
        return this.props.value.map(function (val, index) {
          ...
          }, _this7.formatValue(val)), !_this7.props.disabled && /*#__PURE__*/_react.default.createElement("span", {
            className: "p-autocomplete-token-icon pi pi-times-circle",
            onClick: function onClick(e) {
              return _this7.removeItem(e, index);
            }
          }));
        });
      }
    ...
    value: function render() {
      ...
      var input, dropdown;
      var className = (0, _classnames.default)('p-autocomplete p-component p-inputwrapper', this.props.className, {
